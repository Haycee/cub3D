...
/*   Updated: 2022/06/02 15:06:32 by agirardi         ###   ########lyon.fr   */
/*                                                                            */
/* ************************************************************************** */
...
{
	data->mini_map.ptr = mlx_new_image(data->win.mlx, config->map_wdth * 64, config->map_hgt * 64);
	data->mini_map.addr = mlx_get_data_addr(data->mini_map.ptr, &data->mini_map.bpp, &data->mini_map.line_len, &data->mini_map.endian);
	data->walls.ptr = mlx_new_image(data->win.mlx, data->config.map_wdth * 64, data->config.map_hgt * 64);
